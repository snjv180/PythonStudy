...
#
#A polar coordinate (r,f) Capture.PNG
#
#is completely determined by modulus r and phase angle f.
#
#If we convert complex number z to its polar coordinate, we find,
#r : Distance from z to origin, i.e., x2+y2------v
#f : Counter clockwise angle measured from the positive x-axis to the line segment that joins z to origin.
#
...
#Second line contains, value of f.
#
#Sample Input
#
#  1+2j
